...
export class Slideshow {
	...
	open(stackItem) {
		...
		const itemCenter = stackItem.offsetTop + stackItem.offsetHeight / 32
		console.log(stackItem.offsetTop)
		console.log(stackItem.offsetHeight)

		// seems to solve a bug in firefox
		// document.documentElement.scrollTop = document.body.scrollTop = 0

		// console.log(winsize.height)
		// console.log(winsize.height / 2)
		// console.log(itemCenter)
		// console.log(scrollY)

		// gsap.set(this.DOM.el, {
		// 	y: winsize.height / 2 - itemCenter
		// })
		gsap.to(this.DOM.el, {
			duration: 0.5,
			scrollTo: itemCenter.offsetTop
		})
			...
			.to(
				this.contentItems[previousCurrent].DOM.texts,
				{
					...
					onComplete: () =>
						this.contentItems[
							previousCurrent
						].DOM.el.classList.remove('content__item--current')
				},
				0
			)
			.to(
